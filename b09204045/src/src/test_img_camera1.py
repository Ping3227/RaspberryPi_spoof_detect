...
for x in range(1):
    ...
    if mode == "camera":
        ...
        cap = Picamera2()
        camera_config = cap.create_preview_configuration(main={"size": (1920,1088)}) ## , lores={"size": (640, 480)}, display="lores" 1280 704 1920 1088 
        #cap.set_controls({"AfMode": controls.AfModeEnum.Manual, "LensPosition": 0.0})
    ...
    while frames_received < num_frames and time < 50:
        ...
        cv2.imwrite(f"face1/{frames_received}.jpg" , face)
